...
| **v2 `fraud_payment`** | **0.9976** | **0.8700** | **0.8064** | **0.8223** | **0.7911** |
...
| | v1 | v2 |
|---|---|---|
| training corpus | 2,043,664 rows | **3,896,058** rows |
| fraud train rows | 328,767 | 1,296,675 (`fraud_payment`) |
| financial rows with user history | **0%** | **79.7%** |
...
**Sparkov added** (`kartik2112/fraud-detection`, **CC0-1.0**): 1,852,394 txns,
...
dataset identity. Split honestly: payments 0.9976, applications 0.7927.
...
| `cyber` | `f_user_past_malicious_rate` | beth | **0.9977** |
| `fraud_payment` | — | — | clean |
